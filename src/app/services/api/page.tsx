  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex items-start gap-6 mb-6">
              <div className="p-4 border-2 border-black bg-black text-white">
                <LuCode className="w-10 h-10 sm:w-12 sm:h-12" />
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="bg-white text-black px-8 py-4 text-lg font-semibold hover:bg-gray-100 transition-colors border-2 border-black">
                View Documentation
              </button>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <h2 className="text-3xl sm:text-4xl font-bold mb-12">API Features</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 border-2 border-black hover:bg-black hover:text-white transition-colors text-sm font-semibold"
                >
                  {copiedEndpoint === idx ? (
                    <>
        ...
        <div className="mt-8 text-center">
          <button className="border-2 border-black px-8 py-3 font-semibold hover:bg-black hover:text-white transition-colors">
            View All Endpoints →
          </button>
        </div>
      </div>
      ...
      <div className="border-t-2 border-black bg-black text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-black px-8 py-4 text-lg font-semibold hover:bg-gray-100 transition-colors border-2 border-white">
              Get API Key
            </button>
            <button className="bg-transparent text-white px-8 py-4 text-lg font-semibold hover:bg-white hover:text-black transition-colors border-2 border-white">
              Read Documentation
            </button>
          </div>
        </div>
